...
CRITICAL: Always use `bun` for managing dependencies, installing packages, and running scripts/commands across this entire project. Do not use npm, yarn, or pnpm. Never use `npx` but `bunx` instead.
